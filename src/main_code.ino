...
char mqttPass[] = "<mqttPass>"; // Chave do MQTT API
long ChannelID = <ChannelID>; // ID do canal
char writeAPIKey[] = "<writeAPIKey>"; // Chave de escrita do canal
char readAPIKey[]="<readAPIKey>"; // Chave de leitura do canal
